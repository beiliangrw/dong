...
public class MenuController {
    ...
    public String getMenu(HttpServletRequest request) {
        ...
        array.add(getJsonObject("typeInfo", "商品类别", "layui-icon-table", "typeInfo"));
        array.add(getJsonObject("goodsInfo", "商品详情", "layui-icon-table", "goodsInfo"));
        array.add(getJsonObject("orderInfo", "订单信息", "layui-icon-table", "orderInfo"));
        array.add(getJsonObject("cartInfo", "购物车信息", "layui-icon-table", "cartInfo"));

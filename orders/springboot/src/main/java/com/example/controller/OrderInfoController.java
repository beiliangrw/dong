...
public class OrderInfoController {
    ...
    public Result addDis(@RequestBody OrderInfo orderInfo) {
        ...
        orderInfoService.add(orderInfo, goodsList);
    ...
    @GetMapping("/tuidan/{id}/{userId}")
    public Result tuidan(@PathVariable Long id,@PathVariable Long userId) {
        orderInfoService.tuidan(id,userId);
        return Result.success();
    }
    @GetMapping("/cuidan/{id}/{userId}")
    public Result cuidan(@PathVariable Long id,@PathVariable Long userId) {
        orderInfoService.cuidan(id,userId);
        return Result.success();
    }
}
